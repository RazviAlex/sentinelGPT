...
if __name__ == '__main__':
 ...
 '''
	...
	parser = argparse.ArgumentParser(description='SentinelOneGPT script. v.1.0')
	parser.add_argument("--model", help="Choose the GPT model. Available ones are - 'GPT-3.5T or GPT-4'")	
